<?php
if ( !class_exists( 'KymaConnector_PluginAdmin' ) ) {
    require_once( dirname( __FILE__ ) . '/../lib/openapi-generator.php' );

    class KymaConnector_PluginAdmin
    {
        ...
        public function init() {
            ...
            add_settings_section( 
                ...
                'KymaConnector_PluginAdmin::settings_section_cb', 
                'kymaconnector'
            );
            ...
            add_settings_field(
                ...
                'KymaConnector_PluginAdmin::field_user_cb',
                'kymaconnector',
                'kymaconnector_api_settings'
                );
            ...
            add_settings_field(
                ...
                'KymaConnector_PluginAdmin::field_password_cb',
                'kymaconnector',
                'kymaconnector_api_settings'
                );
            ...
            add_settings_field(
                'kymaconnector_name',
                'Connector Name',
                'KymaConnector_PluginAdmin::field_name_cb',
                'kymaconnector',
                'kymaconnector_api_settings'
            );
            ...
            add_settings_field(
                ...
                'KymaConnector_PluginAdmin::field_description_cb',
                'kymaconnector',
                'kymaconnector_api_settings'
            );

            $this->event_settings = new KymaConnector_EventSettings('kymaconnector');
            $this->event_settings->settings_page();
        }

        public static function options_page() {
            $admin = new KymaConnector_PluginAdmin();
            $admin->init();
        ...
        public function options_page_html(){
            ...
            KymaConnector_PluginAdmin::register_application($this->event_settings->get_event_spec());
        ...
        public static function register_application($event_spec){
            ...
            $api = new KymaConnector_OpenAPIGenerator();
            ...
            $ch = KymaConnector_PluginAdmin::add_clientcert_header($ch);
            ...
            if($code == 200 ){
                ...
                KymaConnector_PluginAdmin::register_application();
            } else {
        ...
        private static function add_clientcert_header( $ch ) {
            $keyFile = "/mkt-cloud.key";
            $certFile = "/mkt-cloud.crt";
    ...
    add_action('admin_menu', 'KymaConnector_PluginAdmin::options_page');
}
